...
interface HeroProps {
  title?: string, breadcrumbs?: null | JSX.Element, description?: string, style?: string, alignment?: string, hasCTA?: boolean,
}

const Hero = ({ title = "Murphy's Magic", breadcrumbs = null, description = "Where the fun comes free", style="light", alignment="center", hasCTA=false }: HeroProps) => {
  return <>
