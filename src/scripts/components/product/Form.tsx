  ...
  return <div className="product-form-section">
    <div className="product-form-section__inner">
      ...
      <form action="" className="product-form form" method="POST">
        ...
        <div className="product-form-prices">
          <div className="product-form-prices__price-wrap">
            <div className="typography-body-sm product-form-prices__label">Wholesale</div>

            <div className="product-form-prices__price product-form-prices__price--wholesale">
              $3.50
            </div>
          </div>
          <div className="product-form-prices__price-wrap">
            <div className="typography-body-sm product-form-prices__label">Retail</div>
            <div className="product-form-prices__price product-form-prices__price--retail">$8.95</div>
          </div>
        </div>
